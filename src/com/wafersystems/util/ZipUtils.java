...
public final class ZipUtils {
	...
	public static void archive(File srcFile, File destFile) throws Exception {
		ZipArchiveOutputStream zaos = new ZipArchiveOutputStream(new FileOutputStream(destFile));
	 ...
	 * 
	 * @param srcFile 源路径
	 * @param zaos ZipArchiveOutputStream
	 * @param basePath 归档包内相对路径
	 * @throws Exception
	 */
	private static void archive(File srcFile, ZipArchiveOutputStream zaos, String basePath) throws Exception {
	 ...
	 * @throws Exception
	 */
	private static void archiveDir(File dir, ZipArchiveOutputStream zaos, String basePath) throws Exception {
	 ...
	 * @throws Exception
	 */
	private static void archiveFile(File file, ZipArchiveOutputStream zaos, String dir) throws Exception {
		//设置编码格式
	 ...
	 * @throws Exception
	 */
	private static void dearchive(File destFile, ZipArchiveInputStream zais)throws Exception {
