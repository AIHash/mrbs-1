...
<script type="text/javascript">
	...
	function refsubmit(){
		...
		$.ajax({type :'POST',  url : '${pageContext.request.contextPath}/icumonitor/refuseicuVisit', 
	...
	function redirctlist(){
	    ...
	    var url;
	    url="<%=request.getContextPath()%>/meeadIndex/icuVisitList";   
...
<body >
	<form method="post" id="refusereasomform"  action="<%=request.getContextPath()%>/icumonitor/refuseicuVisit" onsubmit="return check()">
	     <div id="viewappinfor">
			<div id="titleStyle">
				<span>&nbsp;</span>
			</div>		
