...
<script type="text/javascript"  >
	...
	function passsubmit(){
		...
		if(check()){
			...
			$.ajaxSettings.traditional = true;
			$.ajax({type :'POST',  url : '${pageContext.request.contextPath}/icumonitor/auditIcuMonitor', 
				data :  {meetingApplicationId:meetingApplicationId,startTime:starttime,endTime:endtime,selectedUserIds:selectedUserIds,meetingRoom:meetingRoom,meetingType:meetingType,devicesNo:devicesNo},
				dataType : 'json',
				dataFilter : function(json, type){
					if(json.indexOf('<html>') != -1){
						window.location.href="<%=request.getContextPath()%>/index.jsp?message=system.session_expire";
...
<body id="windows" style="overflow-y:auto;">
  <div id="usual1" class="usual">   
   ...
   <div id="tab1"> 
    <form id="formtongguo" name="formtongguo" method="post" action="<%=request.getContextPath()%>/icumonitor/auditIcuMonitor" onsubmit="">
            ...
            <div class="subinfor" id="patientinfor1">
				  <table class="submit_table" align="center" width="100%" border="1" >
					...
					<tr >
					    ...
					    <td  style="vertical-align:middle;">
									<input style="margin-left:20px;width: 155px;" type="text" name=devicesNo" id = "devicesNo" value = "${mm.devicesNo}" onkeyup="value=value.replace(/[^\d\.]/g,'')"/>
					    </td>
					</tr>
					<tr >
