				...
				<tr id="inputForm"  style="display:block;">
					<td width="210" valign="top">
					     <table width="100%" height="100%">
					         <tr>
					              <td valign="top">
					                   <iframe id="deptTree" valign="top" frameborder="0" name="deptTree" width="145" scrolling="auto" src="${root}/dept/tree"></iframe>
					              </td>
					         </tr>
					     </table>
					</td>
					<td width="515" valign="top">
					     <table width="100%" height="100%">
					         <tr>
					              <td valign="top">
					                   <iframe id="dataFrame" valign="top" frameborder="0" name="deptList" width="515" scrolling="auto" src="${root}/dept/list?nodeNo=${parentNodeNo}"></iframe></td>             
					              </td>
					         </tr>
					     </table>
				</tr>
