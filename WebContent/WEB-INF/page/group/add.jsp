...
<body style="margin-top: 0; margin-bottom: 0;" onload="focus('form','name');javascript:realTimeCount(form.memo,'hint')" >
	...
	<comm:navigator position="admin.title_system_config>>admin.usergroup_manage>>comm.add" />
	<tr>
	...
	<tr id="inputForm" style="display:block;">
		...
		<td class='queryBackground' align="center">
			...
			<tr>
				...
				<td  align="left">&nbsp;&nbsp;<input type="text" name="name" maxlength="32" style="width:200px " /></td>
			</tr>
			<tr>
				...
				<td colspan="3" align="left">&nbsp;&nbsp;<textarea name="remark" maxlength="100" onkeyup="javascript:realTimeCount(this,'hint');"  onkeypress="realTimeCount(this,'hint')"   cols="81" rows="3" title=" <comm:message key="admin.content_maxlength"/>100"></textarea></td>
		  	</tr>
			<tr id="phone">
				<td height="25" align="right" class="text_left_red2"><comm:message key="admin.usergroup.user_name"/>:</td>					
				<td colspan="3">
					<div>
						<input type="checkbox" id="allSelect" onclick="allSelectFun()"><comm:message key="admin.usergroup.selectAll"/><br/>
						<c:forEach var="user" items="${ALL_UNIFIEDUSER}" varStatus="status">
							<input name="userId" type="checkbox" value="${user.userId}" >${user.name}
