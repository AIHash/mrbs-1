...
<body onload="heigthReset(64);" onresize="heigthReset(64);" style="padding:0; margin:0;background:url('../resources/images/theme/bg_right-2.gif');">
	<div id="center">
		...
		<div id="main">
		<form name="MyForm" action="${root}/icumonitor/arrangedIcuMonitorList?applicatonstate=${APPLICATION_STATE_ACCEPT}" method="post" onsubmit="return check()" target="Report">
		...
		<table align="center" width="697">
			...
			<tr>
				<td colspan="3" class="table_middle_bg"><iframe id="dataFrame" align="top" frameborder="0" name="Report" width="700" scrolling="no" src="${root}/icumonitor/arrangedIcuMonitorList?applicatonstate=${APPLICATION_STATE_ACCEPT}"></iframe></td>
			</tr>
		</table>
	</form>
	</div>
