...
<%-- 		            			<span>${myfilelist.type.name}:&nbsp;&nbsp;</span>
	    ...
	    <c:if test="${meeting.state == 3 && satisfaction != null}">
		    <div class="subtitle">
					<div class="titleStyle">
						   <strong><comm:message key='unified.and.expert.evaluation.content' /></strong>
					</div>	    
		    </div>
		    <div class="subinfor" id="patientinfor3">
		       <c:if test="${userinfor.userType.value == 4}">
		         <table border="0" align="center" width="88%">
		             <tr>
		                <td width="14%" align="right"><strong><comm:message key='unified.and.expert_purpose'/></strong>:</td>
		             ...
		             <tr>
		                <td align="right"><strong><comm:message key='unified.and.expert.attend.suggestion'/></strong>:</td>
		             ...
		             <tr>
		                <td align="right"><strong><comm:message key='local.number'/></strong>:</td>
		       ...
		       <c:if test="${userinfor.userType.value == 5}">
		         <table width="100%">
		            <tr>
		               <td width="10%" align="right"><strong><comm:message key='metting.consultationStatistics.purpose'/></strong>:</td>
		               <td>&nbsp;&nbsp;${meeting.title}</td>
		            </tr>
		            <tr>
		               <td width="10%" align="right"><strong><comm:message key='local.number'/></strong>:</td>
		               <td>&nbsp;&nbsp;${satisfaction.localNumber}</td>
		            </tr>
	                <c:forEach var="evaluation" items="${evaluationList}" varStatus="status">
	                    <tr>
	                       <td width="40%" align="right"><strong>${evaluation.name}</strong>:</td>
	                       <td align="left">
		            ...
		            <tr>
		                <td width="20%" align="right"><strong><comm:message key='unified.suggestion'/></strong>:</td>		               
