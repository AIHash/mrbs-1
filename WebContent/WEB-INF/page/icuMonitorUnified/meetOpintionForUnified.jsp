...
<html >
	...
	$(function(){
		 ...
		 $('#mainSubmit').click(function(){
			 ...
			 jConfirm("<comm:message key='unified.and.expert.evaluation.submit'/>", "<comm:message key='meeting.m.infotishi'/>",function(resultConfirm){
				if(resultConfirm){
					 $.post('<%=request.getContextPath()%>/icumonitor/addgroupopintionForUnified',
  ...
  <body id="windows">
  <form name="form1" action="<%=request.getContextPath()%>/icumonitor/addgroupopintionForUnified" method="post">
		  <div id="viewappinfor" >
			<div id="titleStyle">
				<span>&nbsp;</span>
			</div>		
            <div class="subinfor" id="patientinfor1">
			    ...
			    <tr>
			    <td align="center" colspan="2" style="vertical-align:middle;"><strong><comm:message key='manager.icuMonit.Evaluation'/></strong></td>        
