	...
	<table width="700" border="0" cellspacing="0" cellpadding="0" height="100%">
		...
		<tr>
			...
			<ec:table tableId="ec"
		        var="data"
				items="report_data"
				action="${root}/icumonitor/invitedIcuMonitorList?${requestParameter}"
		        title=""
		        width="700"
		        ...
		        sortRowsCallback="">
				<ec:row>
					<ec:column property="iCUMonitorId.patientInfo.name" title="meeting.patientsName" width="20%" sortable="true"/>
				...
				<ec:column property="applicatonstate" title="unified.invite.status" sortable="false"  width="15%">
					...
					<ec:column property="null" title="unified.operater" sortable="false"  width="25%">
						<a style="color:blue;" href="<%=request.getContextPath()%>/icumonitor/meetView/${data.id}" class='various3'><comm:message key='unified.detail'/></a>
						<c:choose >
