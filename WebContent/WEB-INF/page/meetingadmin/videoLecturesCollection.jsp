...
<body style="padding:0; margin:0;background:url('../resources/images/theme/bg_right-2.gif');" class="bg" onload="myAlert();heigthReset(64);" onresize="heigthReset(64);">
	<div id="center">
		<comm:navigator position="manager.videoLectures>>manager.videoLectures.lecturesCollection" />
		  <div id="main" style=" overflow-y:auto;overflow-x:hidden;width:725px;margin:0px;float:left;">
			<form method="post" action="<%=request.getContextPath()%>/meeadmdbd/addVideoLecturesCollection" onsubmit="return check()">
			  ...
			  <div id="viewappinfor">
	            ...
	            <div class="subinfor" id="patientinfor1">
					<table id="shenqing" width="100%" class="shenqing_table" border="0">						
						<tr>
							<td width="15%"  align="right"><comm:message key='unified.lecture.content' />:<span class="required">*</span><div id="hint" style="margin-right: 10px;">(500/500)</div></td>
							<td colspan="3">
							     <textarea name="lectureContent" style="border: 1px solid #7F9DB9;width:98%; height:50px; overflow-y: auto;" id="lectureContent" class="text-long" maxlength="500" onpaste="return realTimeCountClip(this,'hint');" onkeyup="javascript:realTimeCount(this,'hint');" title=" <comm:message key="comm.content_maxlength"/>500"></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
						   <td width="15%"  align="right"><comm:message key='lecture.m.lecturelevel' />:<span class="required">*</span></td>
		                   ...
		                   <td width="30%"  align="right">			
		                      <comm:message key='admin.meetingroom' />:<span class="required">*</span> 
		                   </td>
						   <td>
						...
						<tr >
				            <td  align="right" style="vertical-align:middle;"><comm:message key='metting.speakerName'/>:<span class="required">*</span> </td>		
						...
						<tr >
				            <td align="right" style="vertical-align:middle;"><comm:message key='meeting.m.community'/>:<span class="required">*</span> </td>		
						    <td colspan="3" style="vertical-align:middle;">
						    	<table style="border:1px solid #000;margin-bottom:10px;margin-top:10px;margin-right:20px;"class="submit_table1" >
									<tr>
										<td bgcolor="#D0D0D0" style="height:22px;border-right:1px solid #000;border-left:1px solid #000;"" >
