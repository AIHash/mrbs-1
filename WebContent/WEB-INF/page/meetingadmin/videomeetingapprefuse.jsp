...
<script type="text/javascript">
	...
	function refsubmit(){
		...
		$.ajax({type :'POST',  url : '${pageContext.request.contextPath}/meeadmdbd/refusevideo', 
	...
	function redirctlist(){
	    ...
	    var url;
	    if(meetingappserchflag!=null&&meetingappserchflag==1){
	    	url="<%=request.getContextPath()%>/meeadmdbd/meetingappsearchlist";
	    }else{
...
<body >
	<form method="post" id="refusereasomform"  action="<%=request.getContextPath()%>/meeadmdbd/refusevideo" onsubmit="return check()">
	     <div id="viewappinfor" style="overflow-y:auto;">
			<div id="titleStyle">
				<span>&nbsp;</span>
			</div>		
            <div class="subinfor" id="patientinfor1">
				...
				<table align="center" border="0" cellspacing="0" cellpadding="0" width="100%">
					...
					<tr>
						...
						<td>
							<textarea name="refuseReson" style="width:85%;margin-top:5px;margin-bottom:5px;border:1px solid #7F9DB9;" rows="6" class="text-long" id="refuseReson" maxlength="500" onpaste="return realTimeCountClip(this,'hint');" onkeyup="javascript:realTimeCount(this,'hint');" title=" <comm:message key="comm.content_maxlength"/>500"></textarea>
						</td>
					</tr>
					<tr height="15"></tr>
					<tr>
