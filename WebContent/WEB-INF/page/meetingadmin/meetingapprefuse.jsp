...
<script type="text/javascript">
	...
	function refsubmit(){
		...
		$.ajax({type :'POST',  url : '${pageContext.request.contextPath}/meeadmdbd/refuse', 
...
<body >
	<form method="post" id="refusereasomform"  action="<%=request.getContextPath()%>/meeadmdbd/refuse" onsubmit="return check()">
	     <div id="viewappinfor">
			<div id="titleStyle">
				<span>&nbsp;</span>
			</div>		
