...
<body onload="heigthReset(64);" onresize="heigthReset(64);" style="padding:0; margin:0;background:url('../resources/images/theme/bg_right-2.gif');" class="bg">
	<div id="center">
		<comm:navigator position="vedio.app>>meeting.m.approvalnotthrough" />
<div id="main">
   ...
   <c:forEach var="vm_shenheweitongguo" items="${vm_shenheweitongguo}">
    <tr>
		    ...
		    <td>
			         ...
			         <a style="COLOR:blue;" href="<%=request.getContextPath()%>/meeadmdbd/viewvedioappmeeting/${vm_shenheweitongguo.id}" >
