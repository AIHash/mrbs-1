...
<div id="center">
		<comm:navigator position="vedio.app>>meeting.m.statepass" />
		<div id="main">
  ...
  <tr>
   ...
   <c:forEach var="vm_shenhetongguo" items="${vm_shenhetongguo}">
    ...
    <tr>
	    ...
	    <td>	         
	             <a style="COLOR:blue;" href="<%=request.getContextPath()%>/meeadmdbd/viewvedioappmeeting/${vm_shenhetongguo.id}" ><comm:message key='meeting.m.view'/></a>
