...
$(function(){
	...
	var communitySummary=document.getElementById("communitySummary").value;
	if(communitySummary==""||communitySummary==null)
	 {
...
<body style="overflow-y:auto;">
   <form method="post" action="<%=request.getContextPath()%>/summary/summaryData">
		  <div id="viewappinfor">
			<div id="titleStyle">
				<span>&nbsp;</span>
			</div>		
            <div class="subinfor" id="patientinfor1">
			      ...
			      <table align="center" class="submit_table" height="370"  border="1"  id="summary">
			      <tr>
			          <td align="center" colspan="2" style="font-weight:bold;text-align:center; vertical-align:middle;"><comm:message key='report.meetingSummary'/>
			              <input type="hidden" id="meetingId" name="meetingId" value="${meetingId}">
			          </td>         
			      </tr>
			      <tr>
				      <td width="20%"  align="right" style="vertical-align:middle;"><strong><comm:message key='report.unifiedSummary'/>：</strong><span class="required">*</span><div id="hint" style="margin-right: 10px;">(<span id="tip"></span>/500)</div></td>	
				      <td style="vertical-align:middle;"><textarea name="communitySummary" id="communitySummary" style="width:100%;border: 1px;" rows="5" class="text-long" maxlength="500" onpaste="return realTimeCountClip(this,'hint');" onkeyup="javascript:realTimeCount(this,'hint');" title=" <comm:message key="comm.content_maxlength"/>500">${summary.communitySummary}</textarea>
				      </td>
			      </tr>
			      <tr>
				     <td width="20%" align="right" style="vertical-align:middle;"><strong><comm:message key='report.expertSummary'/>：</strong></td>	
				     <td style="vertical-align:middle;"><textarea name="expertSummary" id="expertSummary" style="width:100%;border: 1px;" rows="5" class="text-long" width="80%" onfocus="this.blur()">${summary.expertSummary}</textarea>
				     </td>
			      </tr>
			      </table>
			      <table align="center">
				        <tr><td>&nbsp;</td></tr>
				        <tr>
				           <td colspan="2" align="center"><input type="button" class="button" id="communitySubmit" align="center" value="提交" ></td>
				       </tr>
				        <tr><td>&nbsp;</td></tr>
			     </table>            
            </div>
...
$(document).ready(function() {
	var count=getUnicodeLength(document.getElementById("communitySummary").value);
   	$('#tip').html(500-count);
});
</script>
</html>