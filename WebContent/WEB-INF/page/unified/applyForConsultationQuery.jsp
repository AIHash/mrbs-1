...
<head>
	...
	<title><comm:message key="common.teleconsultation.applyForConsultation" /></title>
...
<body onload="heigthReset(64);" onresize="heigthReset(64);" style="padding:0; margin:0;background:url('<%=request.getContextPath()%>/resources/images/theme/bg_right-2.gif');">
	<div id="center">
		<comm:navigator position="common.teleconsultation>>common.teleconsultation.applyForConsultation" />
		<div id="main">
		<form name="MyForm" action="${root}/unifiedindex/applyForConsultationList" method="post" target="Report" onsubmit="return check()">
...
<%-- 						 	<td width="25%" class="text_left_red2" align="right">
						 	...
						 	<td width="25%" align="left">
						  		<input type="text" name="applicationTime" id="applicationTime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" size="25" onfocus="this.blur()"
									style="width:155px;height: 20px;line-height:20px;border: 1px solid #7F9DB9;height:20px;background:#fff url(<%=request.getContextPath()%>/resources/My97DatePicker/skin/datePicker.gif) no-repeat right;"
							 	/>
						 	</td> --%>
						</tr>
						<tr>
...
<%-- 						 	<td width="25%" align="left">
						 		<select name="meetingType" id="meetingType" style="width:155px;height:20px;">
									<option value="-1">
										<comm:message key='unified.status.all' />
									</option>
		...
		<table width="697" align="center">
			...
			<tr>
				<td colspan="3" class="table_middle_bg"><iframe id="dataFrame" align="top" frameborder="0" name="Report" width="700" scrolling="no" src="${root}/unifiedindex/applyForConsultationList"></iframe></td>
			</tr>
		</table>
	</form>
	</div>
