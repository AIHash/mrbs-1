...
<body onload="heigthReset(64);" onresize="heigthReset(64);" style="padding:0; margin:0;background:url('<%=request.getContextPath()%>/resources/images/theme/bg_right-2.gif');">
	<div id="center">
		<comm:navigator position="manager.icuMonit>>common.icMonit.applyForConsultation" />
		<div id="main">
		<form name="MyForm" action="${root}/unifiedindex/applyForICUMonitList" method="post" target="Report" onsubmit="return check()">
...
<%-- 						 	<td width="25%" align="left">
		...
		<table width="697" align="center">
			...
			<tr>
				<td colspan="3" class="table_middle_bg"><iframe id="dataFrame" align="top" frameborder="0" name="Report" width="700" scrolling="no" src="${root}/unifiedindex/applyForICUMonitList"></iframe></td>
			</tr>
		</table>
	</form>
	</div>
